...
@section('header')
<div class="mb-4">
    <h2 class="fw-bold text-dark mb-1">Edit Teacher Profile</h2>
...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
            <div class="card-header bg-white border-bottom py-3">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="card-title mb-0 fw-bold">Update Teacher Info</h5>
                        <small class="text-muted">Currently editing: <strong>{{ $teacher->name }}</strong></small>
                    </div>
                </div>
            </div>
            
            <div class="card-body p-4">
                <form action="{{ route('teachers.update', $teacher->id) }}" method="POST" id="editTeacherForm">
                    @csrf
                    @method('PUT')
        ...
        <div class="mt-4 p-3 bg-light rounded-4 border-start border-4 border-primary">
            <div class="d-flex">
                <i class="fas fa-lightbulb text-primary mt-1 me-3"></i>
                <p class="small text-muted mb-0">
                    <strong>Note:</strong> Subject changes will reflect on the teacher's public profile and assigned classes immediately.
                </p>
            </div>
        </div>
    </div>
